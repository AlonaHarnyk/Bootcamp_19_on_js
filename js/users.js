...
// console.log(
//   `The amount of followers of user called ${user.name} is ${user.stats.followers}`
// );
...
// console.log(`The amount of followers of user called ${name} is ${followers}`);
